...
while True:
    ...
    while True: #한페이지에 20개의 리뷰, 마지막 리뷰에서 error발생
        try:
            review=d.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/div[2]/div[3]/div[4]/ul/li['+str(j)+']/div[2]/div[1]/p').text
...
df4.to_csv('finalsenti.txt', header=False, index=False)